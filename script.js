  ...
  const SCENARIOS = [
    {
      ...
      text: "وصلتك رسالة وش تسوي يا “متعدد المهام”؟",
      riskIcon: "📱",
      theme: "phone",
      ...
      choices: [
        ...
        { label: "أضغط فرامل فجأة وأقرأ الرسالة", hint: "قد تفاجئ من خلفك", score: 35, feedback: "اللي وراك ما له ذنب" },
    ...
    },
    {
      ...
      text: "شخص يستعد للعبور هل تعطيه أولوية ولا تسوي نفسك ما شفت؟",
      riskIcon: "🚶🏻‍♂️‍➡️",
      theme: "pedestrian",
      ...
      choices: [
        ...
        { label: "أعبر بسرعة قبل أن ينزل للطريق", hint: "حركة ما لها داعي", score: 5, feedback: "محاولة العبور قبل المشاة قد تعرضه للخطر." },
    ...
    },
    {
      ...
      text: "السيارة أمامك فرملت بسرعة. كيف بتدركها!",
      riskIcon: "🚗",
      theme: "carstop",
